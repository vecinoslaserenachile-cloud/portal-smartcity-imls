...
st.markdown("""
    ...
    /* Baldosas en Desarrollo (Estilo Esmerilado) */
    .tile-dev {
    ...
    .t-sub { font-size: 0.85em; opacity: 0.95; font-weight: 400; line-height: 1.2; }
...
# 4. TABLERO DE CONTROL (HTML COMPRIMIDO PARA EVITAR BUGS)
...
<div class="t-sub">Control de seguridad y bitácora digital de visitas para el recinto municipal.</div></a>
...
<div class="t-sub">Plataforma ciudadana con radio, georeferenciación y herramientas interactivas.</div></a>
...
<div class="t-sub">Sistema inteligente de Social Listening y monitoreo de datos comunales.</div></a>
...
<div class="t-sub">Streaming oficial en vivo.</div></a>
...
<div class="t-sub">Gestión institucional y eventos.</div></a>
...
<div class="t-sub">Capacitación para funcionarios.</div></a>
...
<div class="t-sub">Generador automático de reportes.</div></a>
<div class="tile tile-dev"><div class="badge-dev">PRÓXIMAMENTE</div><div><div class="t-icon" style="filter: grayscale(1);">🏖️</div><div class="t-title" style="color:#7F8C8D !important;">Playas y Humedales</div></div>
<div class="t-sub">Monitoreo ambiental de ecosistemas costeros y biodiversidad.</div></div>
<div class="tile tile-dev"><div class="badge-dev">PRÓXIMAMENTE</div><div><div class="t-icon" style="filter: grayscale(1);">🚍</div><div class="t-title" style="color:#7F8C8D !important;">Smart Tránsito LS</div></div>
<div class="t-sub">Monitoreo de flujo vehicular y rutas.</div></div>
<div class="tile tile-dev"><div class="badge-dev">PRÓXIMAMENTE</div><div><div class="t-icon" style="filter: grayscale(1);">🏗️</div><div class="t-title" style="color:#7F8C8D !important;">Pagos Online</div></div>
<div class="t-sub">Módulo de Rentas y Patentes.</div></div>
</div>"""
